...
;@----------------------------------------------------------------------------
	...
	cmp r2,#0
	ldrhne r0,[v30ptr,#v30PrefixBase+2]
	ldrheq r0,[v30ptr,#v30SRegDS+2]
	add r1,r3,r1
	mov r1,r1,lsl#16
	mov r1,r1,lsr#16
	add r0,r1,r0,lsl#4
	strh r1,[v30ptr,#v30EO+2]
	str r0,[v30ptr,#v30EA]
	bx lr
;@----------------------------------------------------------------------------
EA_001:	;@
...
;@----------------------------------------------------------------------------
	...
	ldrh r3,[v30ptr,#v30RegIX]
	cmp r2,#0
	ldrhne r2,[v30ptr,#v30PrefixBase+2]
	ldrheq r2,[v30ptr,#v30SRegDS+2]
	mov r0,r0,lsl#24
	add r1,r3,r1
	add r1,r1,r0,asr#24
	mov r1,r1,lsl#16
